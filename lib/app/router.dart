...
import '../features/workspace/records_screen.dart';
import '../features/workspace/agenda_screen.dart';
import '../features/workspace/bookmarks_screen.dart';
import '../features/workspace/assistant_screen.dart';
import '../features/workspace/profile_details_screen.dart';
    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/quick-add',
            builder: (_, _) => const QuickAddLaunchScreen(),
          ),
          ...
          GoRoute(
            ...
            builder: (_, state) =>
                ChatScreen(personId: state.pathParameters['personId']!),
          ),
          ...
          GoRoute(
            path: '/shopping/:id',
            builder: (_, state) =>
                ShoppingListScreen(listId: state.pathParameters['id']!),
          ),
          GoRoute(
            path: '/medication',
