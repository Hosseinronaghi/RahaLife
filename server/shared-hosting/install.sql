...
CREATE TABLE IF NOT EXISTS sync_changes (
    ...
    UNIQUE KEY uq_sync_changes_change_id (owner_id, change_id),
...
CREATE TABLE IF NOT EXISTS direct_messages(id VARCHAR(64) NOT NULL,sender_id VARCHAR(64) NOT NULL,recipient_id VARCHAR(64) NOT NULL,body TEXT NOT NULL,created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6),PRIMARY KEY(sender_id,id),KEY conversation(sender_id,recipient_id,created_at)) ENGINE=InnoDB;
